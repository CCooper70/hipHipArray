...
// const chicago = ["Med", "Fire", "P.D.", "Bears", "Bulls"]
...
// const empty = []
// empty.push("Christy", "kenny", "joey")
// empty.unshift("kelly", "harlie")
...
// const copy2 = students.slice(3, 11)// slice doesn't mutate
// for(let i = 0; i < copy2.length; i++){
//   console.log(copy2[i])
// }
// for(let i = 0; i < students.length; i++){
//   console.log("original array", students[i])
// }
...
//I was only able to get a few of these correct.  They were pretty hard, and since I wasnt in class, because of illness, I didn't get the rest.